properties {
    ...
    $build_dir_net3_client_signed = "$build_dir_signed\net35-client"
...
task Zip -depends Package {
    ...
    copy-item $build_dir_net35_client/Mindscape.Raygun4Net.dll $versionfolder3client
    copy-item $build_dir_net35_client/Mindscape.Raygun4Net.pdb $versionfolder3client
    # .NET 4.0
	...
	# Windows Store
    copy-item $build_dir_uwp/Mindscape.Raygun4Net.WindowsStore.dll $versionfolderwindowsstore
    copy-item $build_dir_uwp/Mindscape.Raygun4Net.WindowsStore.pdb $versionfolderwindowsstore
	# Windows Phone
    copy-item $build_dir_windowsphone/Mindscape.Raygun4Net.WindowsPhone.dll $versionfolderwindowsphone
    copy-item $build_dir_windowsphone/windowsphone/Mindscape.Raygun4Net.WindowsPhone.pdb $versionfolderwindowsphone
	# Signed .NET 2
	...
	# Signed .NET 3.5
    copy-item $build_dir_net35_signed/Mindscape.Raygun4Net.dll $signedfolder3
	copy-item $build_dir_net35_signed/Mindscape.Raygun4Net.pdb $signedfolder3
	# Signed .NET 3.5 Client Profile
    copy-item $build_dir_net35_client_signed/Mindscape.Raygun4Net.dll $signedfolder3client
	copy-item $build_dir_net35_client_signed/Mindscape.Raygun4Net.pdb $signedfolder3client
	# Signed .NET 4
	...
	# Signed WinRT
    copy-item $build_dir_signed/Mindscape.Raygun4Net.WinRT.dll $signedfolderwinrt
	copy-item $build_dir_signed/Mindscape.Raygun4Net.WinRT.pdb $signedfolderwinrt
	# Signed UWP
    copy-item $build_dir_signed/Mindscape.Raygun4Net.WindowsStore.dll $signedfolderwindowsstore
