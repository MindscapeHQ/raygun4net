...
namespace Mindscape.Raygun4Net.AspNetCore
{
  public class RaygunClient : RaygunClientBase
  {
    ...
    private readonly ThreadLocal<HttpContext> _currentHttpContext = new(() => null);
    private readonly ThreadLocal<RaygunRequestMessage> _currentRequestMessage = new(() => null);
    private readonly ThreadLocal<RaygunResponseMessage> _currentResponseMessage = new(() => null);
