...
using Mindscape.Raygun4Net.Owin.Builders;

namespace Mindscape.Raygun4Net.Owin
{
  public class RaygunOwinClient : RaygunClientBase
  {
    private readonly string _apiKey;
    protected readonly RaygunRequestMessageOptions _requestMessageOptions = new RaygunRequestMessageOptions();
    private readonly List<Type> _wrapperExceptions = new List<Type>();

    private readonly ThreadLocal<OwinRequest> _currentRequest = new ThreadLocal<OwinRequest>(() => null);
    ...
    /// </summary>
    public RaygunOwinClient() : this(RaygunSettings.Settings.ApiKey) {}

    public RaygunOwinClient(string apiKey)
    {
      _apiKey = apiKey;
    ...
    {
      var message = _currentRequest.Value != null ? await RaygunOwinRequestMessageBuilder.Build(_currentRequest.Value, _requestMessageOptions) : null;
      _currentRequest.Value = null;
      return message;
    }

    internal RaygunOwinClient CurrentRequest(OwinRequest request)
    {
    ...
    {
      var message = RaygunOwinMessageBuilder.New
